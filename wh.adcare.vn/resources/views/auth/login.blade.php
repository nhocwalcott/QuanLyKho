                        ...
                        <div class="span3"></div>
                            <div class="span10">
                                <div class="container-signin" style="margin-top: -30px">
                                    <legend>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWARE HOUSE MANAGER</legend>
                                    @if (count($errors) > 0)
                                    ...
                                    <form  method='POST' id='loginForm' class='form-signin' autocomplete='off' action="{{ url('/auth/login') }}">
                                        ...
                                        <div class="form-inner">
                                            <div class="input-prepend">
                                                <span class="add-on" rel="tooltip" title="" data-placement="top"><i class="icon-user"></i>&nbsp&nbspACCOUNT</span>
                                                <input type="email" class="form-control" name="username" value="{{ old('username') }}">
                                            </div>

                                            <div class="input-prepend"> 
                                                <span class="add-on"><i class="icon-key" style="margin-left:4px;">&nbspPASSWORD</i></span>
