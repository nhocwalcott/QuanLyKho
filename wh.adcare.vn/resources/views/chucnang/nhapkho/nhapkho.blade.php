            ...
            <div class="box">
                ...
                <div class="box-content">
                    <form class="form-inline">
                        <p><b>Nhập kho</b></p>
                        <a href="{!! URL::route('chucnang.nhapkho.getList') !!}"><i class="icon-plus"></i>&nbsp INPUT</a><br><br>
                        <p><b>Bảng kê nhập</b></p>
                        <a href="{!! URL::route('chucnang.nhapkho.getVattu') !!}"><i class="icon-plus"></i>&nbsp DETAIL</a><br>
                        <a href="{!! URL::route('chucnang.nhapkho.danhsach') !!}"><i class="icon-plus"></i>&nbsp INPUT LIST</a><br>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                ...
                <div class="box-content">
                    <div class="form-inline">
                        <div class="container">
                            <form action="{!! URL::route('chucnang.nhapkho.import') !!}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <form action="" method="POST" accept-charset="utf-8">
                                        ...
                                        <div id="acct-password-row" class="span4">
                                            <fieldset>
                                                ...
                                                <div>
                                                    <button type="submit" class="btn btn-primary"><i class="icon-save"></i>&nbsp&nbsp&nbspSAVE</button>
                                                </div>
                                        ...
                                        <div id="acct-password-row" class="span13">
                                            <fieldset>
                                                ...
                                                <div class="control-group ">
                                                    ...
                                                    <select  class="npp_id span7" name="npp_id" id="npp_id">
                                                        <option>--Chọn--</option>
                                                ...
                                                <table class="tb table table-bordered table-hover" id="myTable" name="myTable">
                                                    ...
                                                    @foreach($content as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item['qty'] }}</td>
                                                            <?php
                                                            $ncc = DB::table('nhaphanphoi')->where('id',$item['price'])->first();
                                                            ?>
                                                            <td>{{$ncc->npp_ten}}</td>
                                                            <td class="td-actions">
        ...
        <script>
            $(document).ready(function() {
                $(".add1").click(function() {
                    ...
                    var npp_id = $(this).parent().parent().find(".npp_id").val();
                    ...
                    $.ajax({
                        ...
                        type:'GET',
                        cache:false,
                        data:{"_token":token,"id":id,"qty":qty,"idKho":idKho,"npp_id":npp_id},
